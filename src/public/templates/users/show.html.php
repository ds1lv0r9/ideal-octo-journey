        ...
        <form id="form-rates" method="post" action="/users/edit/<?= $data['user_id'] ?>" class="g-3 login row m-auto p-auto" novalidate>
            <div class="row my-2">
                <div class="col-12 col-md-6">
                    ...
                    <input type="text" id="first_name" name="first_name" value="<?= $data['user']['first_name'] ?? '' ?>" class="form-control text-center" required disabled>
                ...
                <div class="col-12 col-md-6">
                    ...
                    <input type="text" id="last_name" name="last_name" value="<?= $data['user']['last_name'] ?? '' ?>" class="form-control text-center" required disabled>
            ...
            <div class="row my-2">
                <div class="col-12 col-md-6">
                    ...
                    <input type="date" id="birthdate" name="birthdate" value="<?= $data['user']['birthdate'] ?? '' ?>" class="form-control text-center" required disabled>
                ...
                <div class="col-12 col-md-6">
                    ...
                    <input type="text" id="height" name="height" value="<?= $data['user']['height'] ?? '' ?>" class="form-control text-center" required disabled>
                ...
                <div class="col-12">
                    <div class=" form-check">
                        <input class="form-check-input" type="checkbox" value="true" name="club_member"
                               id="club_member" <?= (!empty($data['user']['club_member']) && $data['user']['club_member'] === 'true' ? 'checked' : '') ?> disabled>
